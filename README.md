...
## Create `new_user` with default role `run_as` [🔗demo] (https://www.elastic.co/guide/en/kibana/7.17/using-kibana-with-security.html Configure security in Kibana API)
```json
